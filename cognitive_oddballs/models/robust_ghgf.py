...
class RobustGHGF(Network):
    ...
    def __init__(self, initial_mean=250.0):
        ...
        self.add_nodes(
            ...
            node_parameters={"mean": -6.0, "precision": 1.0, "tonic_volatility": -3.0},
        )

        # Node 1: Noise Parent (x_noise)
        self.add_nodes(
            kind="continuous-state",
            node_parameters={"mean": -6.0, "precision": 2.0, "tonic_volatility": -1.5},
        )
        ...
        self.add_nodes(
            ...
            node_parameters={"mean": initial_mean, "precision": 0.999},
        )

        # Node 3: Observation Node (u_bag)
        self.add_nodes(kind="continuous-state", value_parents=2, volatility_parents=1)
