...
if __name__ == "__main__":
    ...
    # Calculate MAE
    mae_change = np.abs(normative_model_results_change['Belief'] - normative_model_results_change['TruePosition']).mean()
    ...
    # Calculate MAE
    mae_random = np.abs(normative_model_results_random['Belief'] - normative_model_results_random['TruePosition']).mean()
    ...
    nassar_model_with_random_walk.plot_results(normative_model_results_random, env_df=df_random_walk)
