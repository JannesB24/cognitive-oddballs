...
oddball_data = generate_oddball_environment(n_trials=50, oddball_hazard_rate=0.15, sigma=20, change_point_hazard_rate=0.1, seed=42)
#print(oddball_data.head())
random_walk_data = generate_random_walk_environment(n_trials=50, oddball_hazard_rate=0.15, sigma=20, seed=42)
