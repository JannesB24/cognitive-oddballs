...
We evaluate four models within these environments: Two versions of the Hierarchical Gaussian Filter (see Mathys et al. 2011, 2014; Weber et al. 2023) and two versions of change-point models (see Nassar et al. 2010, 2016, 2019 and Nassar and Razmi 2022).
